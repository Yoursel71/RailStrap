...
using RailStrap.UI.Elements.Bootstrapper;
    ...
    static class Frontend
    {
        ...
        private static IBootstrapperDialog GetCustomBootstrapper()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (!App.LaunchSettings.QuietFlag.Active)
                    ShowMessageBox(string.Format(Strings.CustomTheme_Errors_SetupFailed, ex.Message, "RailStrap"), MessageBoxImage.Error); // NOTE: RailStrap is the theme name
        ...
        public static IBootstrapperDialog GetBootstrapperDialog(BootstrapperStyle style)
        {
            return style switch
            {
                ...
                BootstrapperStyle.VideoDialog => new VideoDialog(),
        ...
        public static void ShowBalloonTip(string title, string message, System.Windows.Forms.ToolTipIcon icon = System.Windows.Forms.ToolTipIcon.None, int timeout = 5)
        {
            ...
            {
                Icon = Properties.Resources.IconRailStrap,
