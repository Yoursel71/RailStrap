...
namespace RailStrap
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "RailStrap-QA";
#else
        public const string ProjectName = "RailStrap";
#endif
        public const string ProjectOwner = "RailStrap";
        public const string ProjectRepository = "Yoursel71/RailStrap";
        public const string ProjectDownloadLink = "https://github.com/Yoursel71/RailStrap";
        public const string ProjectHelpLink = "https://github.com/Yoursel71/RailStrap";
        public const string ProjectSupportLink = "https://github.com/Yoursel71/RailStrap/issues/new";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructRailStrapWebUrl();
        ...
        public static string ConstructRailStrapWebUrl()
        {
        ...
        public static void SendStat(string key, string value)
        {
            ...
            // Bloxstrap Labs' infrastructure), so this always no-ops rather than send data there.
        }

        public static void SendLog()
        {
            // see SendStat() - no first-party analytics backend exists for RailStrap yet.
        }
