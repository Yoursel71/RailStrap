...
namespace RailStrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconRailStrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconRailStrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconRailStrap => Properties.Resources.IconRailStrap,
                ...
                BootstrapperIcon.IconRailStrapClassic => Properties.Resources.IconRailStrapClassic,
                _ => Properties.Resources.IconRailStrap
            };
        }
    }
}
